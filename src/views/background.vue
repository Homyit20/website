        ...
        <transition mode="out-in">
          ...
          <div v-else>
            <div class="center-content">
              <p class="lead2">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              工作室在专业上，主要有承接商业项目、开办技术培训参加专业竞赛、
              开发团队产品等业务。就业质量上，不少工作室的前辈们已成功斩获百度、
              阿里、腾讯和字节跳动等互联网龙头企业的offer，创立至今，宏奕早已成
              为学院就业质量最高的团队!娱乐方面,工作室偶尔会进行聚餐，唱K等。
