<template>
    <div class="tech-contain">
        <img class="tech-background" src="../assets/images/背景.png">
              ...
              <ul class="tech-list">
                <li class="after-details">
                    ...
                    <div class="tech-after-people">
                        <img src="../assets/images/宇航员1.png" class="tech-people">
                    </div>
                </li>
                <li class="before-details">
                    <div class="tech-before-people">
                        <img src="../assets/images/宇航员2_03.png" class="tech-people">
                    </div>
                ...
                <li class="ui-details">
                    ...
                    <div class="tech-ui-people">
                        <img src="../assets/images/宇航员3_03.png" class="tech-people">
                    </div>
                </li>
              </ul>
            </div>
